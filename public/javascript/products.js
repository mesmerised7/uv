...
let productlist=['TRACTORS','ROTAVATORS','COMBINE HARVESTERS AND BALERS']
let tractorhtml=``;
let rotavatorshtml=``;
let combinehtml=``;
products.forEach((product)=>{
    if (product.search[0].toLowerCase()==='tractors'){
        tractorhtml+=`
        <div class="product">
    ...
    if (product.search[0].toLowerCase()==='rotavators'){
        rotavatorshtml+=`
        <div class="product">
        <div class="product-img">
            <img src="${product.image}" alt="">
    ...
    if (product.search[0]==='COMBINE HARVESTERS AND BALERS'){
        combinehtml+=`
        <div class="product">
        <div class="product-img">
            <img src="${product.image}" alt="">
...
document.querySelector('.tractors').innerHTML=tractorhtml;
document.querySelector('.rotavators').innerHTML=rotavatorshtml;
document.querySelector('.combine-balers').innerHTML=combinehtml;
function navfunc(){
